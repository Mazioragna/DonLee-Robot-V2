...
FORCE_CHANNEL = os.environ.get("FORCE_CHANNEL", "movie_club_arena")
SAVE_USER = os.environ.get("SAVE_USER", "no").lower()
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "@movie_club_arena")
...
BOLD = os.environ.get("FILE_CAPTION", "bold")
